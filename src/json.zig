// from https://github.com/ziglang/zig/blob/404bbd385592e79c939f851b9d17c94d209bdde0/lib/std/json.zig
// this is needed over std.json for now as it allows ignoring unknown fields
